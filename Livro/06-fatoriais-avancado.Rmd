...
knitr::include_graphics("../Aulas/images/dadosyates.png")
```
...
knitr::include_graphics("../Aulas/images/yatesout.png")
```
...
knitr::include_graphics("../Aulas/images/Efeito_TK_yates.svg")
```
...
arestas_com_bloco <- tibble(
  de   = c("Média", "Efeitos principais\n(A,B,C,D)", "Interações duplas\n(6 termos)",
           "Interações triplas\n(4 termos)", "Interações triplas\n(4 termos)"),
  para = c("Efeitos principais\n(A,B,C,D)", "Interações duplas\n(6 termos)",
           "Interações triplas\n(4 termos)", "Bloco", "ABCD")
)

cowplot::plot_grid(
  plot_hasse(nos_sem_bloco, arestas_sem_bloco,
             titulo = "Sem bloco: 2⁴ saturado (N=16)"),
  plot_hasse(nos_com_bloco, arestas_com_bloco,
